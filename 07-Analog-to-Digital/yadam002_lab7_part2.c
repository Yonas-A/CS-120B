 ...
 *      Demo Link: <https://youtu.be/jg9E_1effeU>
 * 
 *      MAX value for lab3 and 4 was determined by exposing the photoresistor to
 *      a flashlight and reading the 10-bit binary values from the led and 
 *      converting it to HEX.
 *      The LED's were connected in D1 D2 B7 B6 B5 B4 B3 B2 B1 B0  with D1 as 
 *      the most significant bit and B0 as the least significant bit
 */
